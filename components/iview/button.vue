<template>
	<button :class="['i-btn', long ? 'i-btn-long' : '','i-btn-' + size , 'i-btn-' + type , 'i-btn-' + shape ,  loading ? 'i-btn-loading' : '' , disabled ? 'i-btn-disabled' : '', inline ? 'i-btn-inline' : '' ]"
	 hover-class="i-btn-hover" @click="handleTap" :open-type="openType" :app-parameter="appParameter"
	 ...
	 :send-message-img=" sendMessageImg " :show-message-card=" showMessageCard " :bindcontact="bindcontact"
	 :bindgetuserinfo="bindgetuserinfo" :bindgetphonenumber="bindgetphonenumber" binderror="binderror" plain="true">
